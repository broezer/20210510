...
function draw() {
  ...
  push();
  rotate(HALF_PI);
  image(pg,0,height * -1, width, height);
  pop();
  
  translate((-width/4.75), 0);
  for (let i = 1; i <=3; i++) {
    let lineX = (i * (width * 0.15)) + (i * (width * 0.15));
    image(pg,lineX, height*0.1, width*0.2, height*0.2);
  }
  
  for (let i = 1; i <=3; i++) {
    let lineX = (i * (width * 0.15)) + (i * (width * 0.15));
    image(pg02, lineX , height*0.1 + height*0.3, width*0.2, height*0.2);
  }
  
  for (let i = 1; i <=3; i++) {
    let lineX = (i * (width * 0.15)) + (i * (width * 0.15));
    image(pg, lineX , height*0.1 + height*0.6, width*0.2, height*0.2);
  }
